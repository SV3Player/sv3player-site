    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--theme-background)' }}>
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <nav className="text-sm mb-6">
          ...
          <span className="mx-2" style={{ color: 'var(--theme-text-tertiary)' }}>/</span>
          <span style={{ color: 'var(--theme-text-secondary)' }}>Jellyfin</span>
        </nav>
        ...
        <section className="mb-10">
          ...
          <ol className="list-decimal list-inside space-y-2" style={{ color: 'var(--theme-text-secondary)' }}>
            ...
            <li>Tap <strong style={{ color: 'var(--theme-text-primary)' }}>Add Service</strong> and select <strong style={{ color: 'var(--theme-text-primary)' }}>Jellyfin</strong></li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2" style={{ color: 'var(--theme-text-secondary)' }}>
            ...
            <li><strong style={{ color: 'var(--theme-text-primary)' }}>API prefix:</strong> None (unlike Emby)</li>
          </ul>
        </section>
      </div>
    </div>
