  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      <nav className="text-sm mb-6">
        ...
        <span className="mx-2 text-gray-400">/</span>
        <span className="text-gray-600 dark:text-gray-400">Emby</span>
      </nav>

      <h1 className="text-4xl font-bold mb-4">Emby</h1>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2">
          ...
          <li>Tap <strong className="text-foreground">Add Service</strong> and select <strong className="text-foreground">Emby</strong></li>
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
          ...
          <li><strong className="text-foreground">API prefix:</strong> <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded text-sm">/emby/</code></li>
        </ul>
      </section>
    </div>
  );
